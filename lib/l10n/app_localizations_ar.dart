...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get reAddMeal => 'إعادة إضافة وجبة';
  ...
  String get onboardingAddDescription =>
      'يمكنك تسجيل الوجبات هنا باستخدام الباركود والبحث وتحليل النصوص والصور بالذكاء الاصطناعي. يمكنك استخدام تحليل التغذية بالذكاء الاصطناعي 10 مرات مجاناً، وبعد ذلك يجب مشاهدة الإعلانات للحصول على المزيد من الأرصدة.';
