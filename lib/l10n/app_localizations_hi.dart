...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get onboardingAddDescription =>
      'आप यहाँ बारकोड, खोज और एआई टेक्स्ट और इमेज एनालिसिस का उपयोग करके भोजन लॉग कर सकते हैं। आप हमारी एआई पोषण विश्लेषण का 10 बार मुफ्त उपयोग कर सकते हैं, इसके बाद आपको अधिक क्रेडिट के लिए विज्ञापन देखने होंगे।';
